...
* @returns {boolean}
*/
export function is_bankrupt(margin_account_data: Uint8Array, marginfi_group_data: Uint8Array, utp_observer_data: Uint8Array): boolean;
/**
* @param {Uint8Array} margin_account_data
* @param {Uint8Array} marginfi_group_data
* @param {Uint8Array} utp_observer_data
* @returns {boolean}
*/
export function rebalance_withdraw_valid(margin_account_data: Uint8Array, marginfi_group_data: Uint8Array, utp_observer_data: Uint8Array): boolean;
/**
...
* @returns {WasmDecimal}
*/
export function get_max_rebalance_deposit_amount(observation: WasmObservation, margin_account_data: Uint8Array, marginfi_group_data: Uint8Array, utp_observer_data: Uint8Array): WasmDecimal;
/**
* @param {WasmObservation} observation
* @param {Uint8Array} margin_account_data
* @param {Uint8Array} marginfi_group_data
...
* @returns {WasmDecimal}
*/
export function get_max_rebalance_withdraw_amount(observation: WasmObservation, margin_account_data: Uint8Array, marginfi_group_data: Uint8Array, utp_observer_data: Uint8Array): WasmDecimal;
/**
...
* @returns {boolean}
*/
export function liquidation_valid(margin_account_data: Uint8Array, marginfi_group_data: Uint8Array, utp_observer_data: Uint8Array): boolean;
/**
* @param {Uint8Array} margin_account_data
* @param {Uint8Array} marginfi_group_data
...
* @returns {BigInt}
*/
export function get_quote_balance(margin_account_data: Uint8Array, marginfi_group_data: Uint8Array, deposit: boolean): BigInt;
/**
* @param {Uint8Array} margin_account_data
* @param {Uint8Array} marginfi_group_data
...
* @returns {WasmDecimal}
*/
export function get_margin_requirement(margin_account_data: Uint8Array, marginfi_group_data: Uint8Array, wasm_mreq_t: number): WasmDecimal;
/**
* @param {WasmObservation} wasm_observation
* @returns {BigInt}
*/
