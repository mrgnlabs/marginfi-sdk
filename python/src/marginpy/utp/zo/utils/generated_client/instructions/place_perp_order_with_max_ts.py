...
class PlacePerpOrderWithMaxTsArgs(typing.TypedDict):
    is_long: bool
    limit_price: int
...
class PlacePerpOrderWithMaxTsAccounts(typing.TypedDict):
    state: PublicKey
...
def place_perp_order_with_max_ts(
    args: PlacePerpOrderWithMaxTsArgs, accounts: PlacePerpOrderWithMaxTsAccounts
    ...
    identifier = b"\xaeS\xd4\x95\x98\\\x13\xc8"
