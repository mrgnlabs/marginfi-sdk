...
LiquidationEventKind = typing.Union[Perp, Spot]
LiquidationEventJSON = typing.Union[PerpJSON, SpotJSON]


def from_decoded(obj: dict) -> LiquidationEventKind:
...
def from_json(obj: LiquidationEventJSON) -> LiquidationEventKind:
    if obj["kind"] == "Perp":
        return Perp()
    if obj["kind"] == "Spot":
        return Spot()
